...
#ifndef QUANT_MATH_DOWNANDOUTOPTION_H
#define QUANT_MATH_DOWNANDOUTOPTION_H

#include "KnockOutOption.h"

class DownAndOutOption : public KnockOutOption {
    DownAndOutOption(float32_t expiryTime, float32_t strikePrice, bool isCall, float32_t barrier) : KnockOutOption(expiryTime, strikePrice, isCall, barrier) {}
...
#endif //QUANT_MATH_DOWNANDOUTOPTION_H
